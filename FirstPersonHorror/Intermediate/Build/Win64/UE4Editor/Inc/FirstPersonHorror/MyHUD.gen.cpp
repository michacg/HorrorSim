...
#include "FirstPersonHorror/MyHUD.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRSTPERSONHORROR_API UClass* Z_Construct_UClass_AMyHUD_NoRegister();
	FIRSTPERSONHORROR_API UClass* Z_Construct_UClass_AMyHUD();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMyHUD_Statics::NewProp_HUDFont = { "HUDFont", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMyHUD, HUDFont), Z_Construct_UClass_UFont_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMyHUD_Statics::NewProp_HUDFont_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMyHUD_Statics::NewProp_HUDFont_MetaData)) };
	...
	IMPLEMENT_CLASS(AMyHUD, 1153911094);
	template<> FIRSTPERSONHORROR_API UClass* StaticClass<AMyHUD>()
	{
		return AMyHUD::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyHUD(Z_Construct_UClass_AMyHUD, &AMyHUD::StaticClass, TEXT("/Script/FirstPersonHorror"), TEXT("AMyHUD"), false, nullptr, nullptr, nullptr);
