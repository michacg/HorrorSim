...
#define UE_PROJECT_NAME FirstPersonHorror
#define UE_TARGET_NAME FirstPersonHorrorEditor
#define UE_MODULE_NAME "FirstPersonHorror"
...
#define FIRSTPERSONHORROR_API DLLEXPORT
